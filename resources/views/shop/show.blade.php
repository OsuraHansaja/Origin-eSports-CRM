    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col lg:flex-row items-center">
            ...
            <div class="w-full lg:w-1/2 lg:pl-12">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex space-x-4">
                        @foreach (['S', 'M', 'L', 'XL', 'XXL'] as $size)
                            <button class="size-option px-4 py-2 border border-gray-500 text-gray-300 rounded-md focus:outline-none hover:bg-orange-500 hover:text-white" data-size="{{ $size }}">
                                {{ $size }}
                            </button>
                        @endforeach
                    </div>
                ...
                <!-- Add to Cart Button -->
                <button class="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-lg">Add to Cart</button>
            </div>
        </div>
    </div>
